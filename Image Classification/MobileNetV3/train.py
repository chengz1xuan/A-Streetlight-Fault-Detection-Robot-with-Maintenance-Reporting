...
dataloaders = {
    ...
    "val": DataLoader(image_datasets["val"], batch_size=4, shuffle=False, num_workers=2),
...
save_path = "/data/czx/StreetlightsClassification/MobileNetV3/best_mobilenetV3_public.pth"
